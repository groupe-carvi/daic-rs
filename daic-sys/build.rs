...
fn generate_bindings_if_needed() {
    ...
    if binding_needs_regen {
        ...
        let mut builder = bindgen::Builder::default()
            ...
            .opaque_type("std::.*")
            .opaque_type("dai::Device")
            .opaque_type("dai::Version")
            .opaque_type("dai::Pipeline")
            .opaque_type("dai::Node")
            .opaque_type("dai::Camera")
            .opaque_type("dai::AssetManager")
            .opaque_type("dai::CalibrationHandler")
